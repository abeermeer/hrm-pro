    ...
    <main className="min-h-screen flex">
      <div className="flex-1 flex items-center justify-center px-4 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="mt-2 text-gray-600">Start managing your HR in minutes</p>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-indigo-600 to-purple-700 items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <p className="text-indigo-100 text-lg">
            Free for up to 5 employees. No credit card required. Setup in under 5 minutes.
          </p>
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>Core HR modules included</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/></svg>
            ...
            <div className="flex items-center gap-3">
              ...
              <span>Document vault & org chart</span>
            </div>
          </div>
        </div>
      </div>
